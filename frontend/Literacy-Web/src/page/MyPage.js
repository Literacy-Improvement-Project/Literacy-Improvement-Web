...
import { dictionaryWordsRequest, searchWordsRequest, wordDeleteRequest } from "../redux";
...
function MyPage({ dictionaryWordsList, searchWordsList, dictionaryWordsRequest, searchWordsRequest, wordDeleteRequest }) {
    useEffect(() => {
        // 렌더링
